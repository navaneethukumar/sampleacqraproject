 ...
 * </p>
 */
public class GuarentedReport implements IReporter {

    private static final Logger LOG = Logger.getLogger(GuarentedReport.class);
    ...
    public List<MethodResult> removeFailedTest(List<MethodResult> methods){
    	...
    	List<MethodResult> newMethods = new ArrayList<GuarentedReport.MethodResult>();
    	int i=0;
