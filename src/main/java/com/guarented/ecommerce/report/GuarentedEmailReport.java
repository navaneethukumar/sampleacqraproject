package com.guarented.ecommerce.report;
 ...
 * </p>
 */
public class GuarentedEmailReport implements IReporter {

    private static final Logger LOG = Logger.getLogger(GuarentedEmailReport.class);
    ...
    public List<MethodResult> removeFailedTest(List<MethodResult> methods){
    	...
    	List<MethodResult> newMethods = new ArrayList<GuarentedEmailReport.MethodResult>();
    	int i=0;
