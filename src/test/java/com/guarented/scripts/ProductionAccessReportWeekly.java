...
public class ProductionAccessReportWeekly {
	...
	public void productionAccessReportDownload() throws InterruptedException, IOException{
		...
		try{
			...
			try {
				...
				htmlStringBuilderHead.append("<html><head><title>Production Access Weekly Report</title></head>");
				htmlStringBuilderHead.append("<body><center>");
				htmlStringBuilderHead.append("<b><u>Production Access Report On : "+LocalDate.now()+"</u></b>");
			...
			htmlStringBuilderHead.append("<html><head><title>Production Access Weeky Report</title></head>");
			htmlStringBuilderHead.append("<body><center>");
			htmlStringBuilderHead.append("<b>Production Access Report On : "+LocalDate.now()+"</b>");
			htmlStringBuilderHead.append("<br>");
			htmlStringBuilderHead.append("<br>");
			htmlStringBuilderHead.append("<table border=\"1\" bordercolor=\"#000000\">");
		...
		String htmlfile="./test-output/BugzillaProductionAccessWeekly.html";
